...
class Secret(_message.Message):
    __slots__ = ["kemCipherText", "name", "publicKey", "type", "version"]
    ...
    type: Secret.KeyType
    version: int
    def __init__(self, name: _Optional[str] = ..., version: _Optional[int] = ..., type: _Optional[_Union[Secret.KeyType, str]] = ..., kemCipherText: _Optional[bytes] = ..., publicKey: _Optional[bytes] = ...) -> None: ...
